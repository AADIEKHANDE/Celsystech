                        ...
                        <div className="grid grid-cols-12 mt-15 ">
                            ...
                            >
                                ...
                                <motion.p
                                    ...
                                    className="mt-10 text-justify text-lg text-gray-800"
                                >
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.9 }}
                                    className="mt-15 bg-emerald-500 text-white px-6 py-2 transition duration-300 ease-in-out transform rounded-lg shadow-md hover:bg-emerald-700 "
                                >
                                    Get a Quote
                                </motion.button>
                            </motion.div>
